...
def main():
    ...
    while cikis == 'H' or cikis == 'h':
        ...
        if secim == 1:
            ...
            alan, cevre, kare = dikdortgen_bilgilerini_hesapla(kenar1,
                                                               kenar2)  # fonksiyon cagriliyor, 3 tane deger donuyor...
            ...
            n = sayi_al(0, 10)
            print(
                f"{n}!={faktoriyel(n)}")  # fonksiyonun dondurdugu deger, baska bir fonksiyona parametre olarak gonderiliyor...
        elif secim == 4:
